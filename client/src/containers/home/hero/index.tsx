    ...
    <div className="container w-full">
      <div className="space-y-10 py-40">
        <section className="space-y-6">
          <h1 className="text-2xl max-w-4xl">A global study by <span className="font-semibold">The Nature Conservancy</span> has identified <span className="text-sky">funding opportunities for NCS</span> in 8 countries.</h1>
          ...
          <div className="grid grid-cols-2 gap-20">
            <div className="space-y-5">
              <div>
                ...
                <p>However, despite the unprecedented momentum on both public and private funding sources, there is still an outstanding question on how to fund NCS at scale.</p>
              </div>
